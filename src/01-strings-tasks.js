...
function getRectangleString(width, height) {
  ...
  let centre = `│${' '.repeat(width - 2)}│\n`;
  let bottom = `└${'─'.repeat(width - 2)}┘\n`;
  return top + centre.repeat(height -2) + bottom;
}
...
function encodeToRot13(str) {
  ...
  let encod = 'NOPQRSTUVWXYZABCDEFGHIJKLMnopqrstuvwxyzabcdefghijklm';
  return str.replace(/[a-z]/gi, (char) => encod[orig.indexOf(char)]);
}
